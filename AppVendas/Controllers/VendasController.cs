...
namespace AppVendas.Controllers
{
    public class VendasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VendaID,VendaName,NotaFiscal,DataVenda,TotalVenda,ClienteId")] Venda venda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("VendaID,VendaName,NotaFiscal,DataVenda,TotalVenda,ClienteId")] Venda venda)
        {
            if (id != venda.VendaID)
            {
                return NotFound();
